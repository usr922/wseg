...
class PolyAdam(torch.optim.Adam):

    def __init__(self, params, lr, weight_decay, max_step, momentum=0.9, betas=(0.9, 0.999)):
        super().__init__(params, lr, weight_decay=weight_decay, betas=betas)
